...
Remember, here is a PCA dimension reduction of the TB Nanostring dataset. The points are colored based on TB status.
...
Now try an SVM on the Nanostring data:
\scriptsize
```{r}
fit = svm(Condition ~ ., data = pca_reduction, scale = FALSE, 
